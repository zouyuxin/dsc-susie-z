...
![DAP result: A is the probability of different credible set. B is the PIP of the top 10 SNPs](P75full_data_1_get_sumstats_1_dap_z_1_plot_dap_1.plot_file.pdf){width=100%}
...
![finemap result: A is the posterior of number of causals. B is the probability of different configuration. C is the PIP of the top 10 SNPs.](P75full_data_1_get_sumstats_1_finemap_1_plot_finemap_1.plot_file.pdf){width=10cm; height=7cm}
