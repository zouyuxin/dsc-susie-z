...
![DAP result: A is the probability of different credible set. B is the PIP of the top 10 SNPs](output/full_data_1_get_sumstats_1_dap_z_1_plot_dap_1.plot_file.pdf)

<!--
```{r, fig.align="center", fig.cap=c("DAP result: A is the probability of different credible set. B is the PIP of the top 10 SNPs"), echo=FALSE}
knitr::include_graphics("./output/full_data_1_get_sumstats_1_dap_z_1_plot_dap_1.plot_file.pdf")
```
-->

The 95% confidence set from finemap contains 28 SNPs, 3 of them are true signals.

![finemap result: A is the posterior of number of causals. B is the probability of different configuration. C is the PIP of the top 10 SNPs](./output/full_data_1_get_sumstats_1_finemap_1_plot_finemap_1.plot_file.pdf){width=90%}

<!--
\begin{figure}
\includegraphics{'output/full_data_1_get_sumstats_1_finemap_1_plot_finemap_1.plot_file.pdf'}
\caption{finemap result: A is the posterior of number of causals. B is the probability of different configuration. C is the PIP of the top 10 SNPs.}
\end{figure}
-->
