...
```{r}
dscout = readRDS('output/r_compare_add_z_lambda_caviar_dscout_finemap_tibble.rds')
dscout = dscout[,-c(2,6,8,11:14)]
...
```{r}
dscout.finemap.list = list('in_sample' = dscout %>% filter(dscout$ld_method == 'in_sample' & dscout$add_z == FALSE),
...
saveRDS(roc, 'output/r_compare_add_z_lambda_caviar_FINEMAP_ROC.rds')
```

```{r fig.width=6, fig.height=5}
roc = readRDS('output/r_compare_add_z_lambda_caviar_FINEMAP_ROC.rds')
chunks = 0
smooth = FALSE
