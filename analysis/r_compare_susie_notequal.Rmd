...
The model from susie_bhat all converge. But lots of cases with out-sample R failed. The error could be negative residual variance. 
```{r}
...
valid.out = aggregate(valid ~ n_signal + pve, dscout.notequal.susieb.out_sample, sum)
total.out = aggregate(DSC~ n_signal + pve, dscout.notequal.susieb.out_sample, length)
