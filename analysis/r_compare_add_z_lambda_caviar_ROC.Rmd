...
labels = vector()
i = 1
roc.notest = list(CAVIAR = caviar$out_sample, FINEMAP = finemap$in_sample, SuSiEb = susieb.l2$out_sample.notest, SuSiErss = susierss.l2$out_sample.notest, SuSiErss.lamb2 = susierss.l2$out_sample.notest.lamb2)
tmp = list()
for (method in names(roc.notest)) {
  TPR = roc.notest[[method]]$counts$true_positive/roc.notest[[method]]$counts$total_signal
  FPR = roc.notest[[method]]$counts$false_positive/roc.notest[[method]]$counts$total_null
...
for (method in names(roc.notest)) {
  yy = make_smooth(roc.notest[[method]]$FPR, roc.notest[[method]]$TPR)
  if (i == 1) {
    plot(yy$x, yy$y, t="l", col=colors[i], ylab = "True Positive Rate", xlab ="False Positive Rate", main = 'ROC L = 2', bty='l', lwd = 3, xlim = c(0,0.005), ylim = c(0,0.6))
  } else {
    lines(yy$x, yy$y, col=colors[i], lwd = 2, xlim = c(0,0.005), ylim = c(0,0.6))
  }
  #add_text(dat[[method]]$rates$Threshold, yy$x, yy$y, 0.9, colors[i])
...
labels = vector()
i = 1
roc.notest = list(CAVIAR = caviar$out_sample, FINEMAP = finemap$in_sample, SuSiEb = susieb.l5$out_sample.notest, SuSiErss = susierss.l5$out_sample.notest, SuSiErss.lamb2 = susierss.l5$out_sample.notest.lamb2)
tmp = list()
for (method in names(roc.notest)) {
  TPR = roc.notest[[method]]$counts$true_positive/roc.notest[[method]]$counts$total_signal
  FPR = roc.notest[[method]]$counts$false_positive/roc.notest[[method]]$counts$total_null
...
for (method in names(roc.notest)) {
  yy = make_smooth(roc.notest[[method]]$FPR, roc.notest[[method]]$TPR)
  if (i == 1) {
    plot(yy$x, yy$y, t="l", col=colors[i], ylab = "True Positive Rate", xlab ="False Positive Rate", main = 'ROC L =5', bty='l', lwd = 3, xlim = c(0,0.005), ylim = c(0,0.6))
  } else {
    lines(yy$x, yy$y, col=colors[i], lwd = 2, xlim = c(0,0.005), ylim = c(0,0.6))
  }
  #add_text(dat[[method]]$rates$Threshold, yy$x, yy$y, 0.9, colors[i])
...
labels = vector()
i = 1
roc.notest = list(CAVIAR = caviar$out_sample.addz, FINEMAP = finemap$in_sample.addz, SuSiEb = susieb.l5$out_sample.addz.notest, SuSiErss = susierss.l5$out_sample.addz.notest, SuSiErss.lamb2 = susierss.l5$out_sample.addz.notest.lamb2)
tmp = list()
for (method in names(roc.notest)) {
  TPR = roc.notest[[method]]$counts$true_positive/roc.notest[[method]]$counts$total_signal
  FPR = roc.notest[[method]]$counts$false_positive/roc.notest[[method]]$counts$total_null
...
labels = vector()
i = 1
roc.est = list(CAVIAR = caviar$out_sample, FINEMAP = finemap$in_sample, SuSiEb = susieb.l2$out_sample.est, SuSiErss = susierss.l2$out_sample.est, SuSiErss.lamb2 = susierss.l2$out_sample.est.lamb2)
tmp = list()
for (method in names(roc.est)) {
  TPR = roc.est[[method]]$counts$true_positive/roc.est[[method]]$counts$total_signal
  FPR = roc.est[[method]]$counts$false_positive/roc.est[[method]]$counts$total_null
...
labels = vector()
i = 1
roc.est = list(CAVIAR = caviar$out_sample, FINEMAP = finemap$in_sample, SuSiEb = susieb.l5$out_sample.est, SuSiErss = susierss.l5$out_sample.est, SuSiErss.lamb2 = susierss.l5$out_sample.est.lamb2)
tmp = list()
for (method in names(roc.est)) {
  TPR = roc.est[[method]]$counts$true_positive/roc.est[[method]]$counts$total_signal
  FPR = roc.est[[method]]$counts$false_positive/roc.est[[method]]$counts$total_null
...
labels = vector()
i = 1
roc.est = list(CAVIAR = caviar$out_sample.addz, FINEMAP = finemap$in_sample.addz, SuSiEb = susieb.l5$out_sample.addz.est, SuSiErss = susierss.l5$out_sample.addz.est, SuSiErss.lamb2 = susierss.l5$out_sample.addz.est.lamb2)
tmp = list()
for (method in names(roc.est)) {
  TPR = roc.est[[method]]$counts$true_positive/roc.est[[method]]$counts$total_signal
  FPR = roc.est[[method]]$counts$false_positive/roc.est[[method]]$counts$total_null
