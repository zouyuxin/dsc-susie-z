...
```{r}
dscout.susieb = dscout[as.logical((dscout$method == 'susie_b')*(dscout$L == 5)*(!is.na(dscout$converged))),]
dscout.susieb.list = list('in_sample' = dscout.susieb[dscout.susieb$ld_method == 'in_sample',],
                          'out_sample' = dscout.susieb[as.logical((dscout.susieb$ld_method == 'out_sample')*(dscout.susieb$add_z == FALSE)),],
                          'out_sample.addz' = dscout.susieb[as.logical((dscout.susieb$ld_method == 'out_sample')*(dscout.susieb$add_z == TRUE)),],
                          'all' = dscout.susieb[as.logical((dscout.susieb$ld_method == 'all')*(dscout.susieb$add_z == FALSE)),],
                          'all.addz' = dscout.susieb[as.logical((dscout.susieb$ld_method == 'all')*(dscout.susieb$add_z == TRUE)),])
...
dscout.susieb = dscout.susieb[dscout.susieb$L == 5,]
dscout.susieb.suc = dscout.susieb[!is.na(dscout.susieb$converged),]
dscout.susieb.suc = dscout.susieb.suc[dscout.susieb.suc$n_signal == 1,]
dscout.susieb.suc.list = list('in_sample' = dscout.susieb.suc[dscout.susieb.suc$ld_method == 'in_sample',],
                              'out_sample' = dscout.susieb.suc[as.logical((dscout.susieb.suc$ld_method == 'out_sample')*(dscout.susieb.suc$add_z == FALSE)),],
                              'out_sample.addz' = dscout.susieb.suc[as.logical((dscout.susieb.suc$ld_method == 'out_sample')*(dscout.susieb.suc$add_z == TRUE)),],
                              'all' = dscout.susieb.suc[as.logical((dscout.susieb.suc$ld_method == 'all')*(dscout.susieb.suc$add_z == FALSE)),],
                              'all.addz' = dscout.susieb.suc[as.logical((dscout.susieb.suc$ld_method == 'all')*(dscout.susieb.suc$add_z == TRUE)),])
```

```{r}
dat = list('in_sample'=matrix(NA, 0, 2), 'out_sample'=matrix(NA, 0, 2), 'out_sample.addz'=matrix(NA, 0, 2), 'all'=matrix(NA, 0, 2), 'all.addz'=matrix(NA, 0, 2))
for(method in names(dat)){
  for(j in 1:nrow(dscout.susieb.suc.list[[method]])){
    datj = cbind(dscout.susieb.suc.list[[method]]$susie.pip[[j]], as.integer(dscout.susieb.suc.list[[method]]$meta[[j]]$true_coef!=0))
