...
for(Rtype in names(dat)){
  for(j in 1:nrow(dscout.susieb.list[[Rtype]])){
    datj = cbind(dscout.susieb.list[[Rtype]]$susie.pip[[j]], dscout.susieb.list[[Rtype]]$meta[[j]]$true_coef)
...
for(method in names(dat)){
  for(j in 1:nrow(dscout.susieb.suc.list[[method]])){
    datj = cbind(dscout.susieb.suc.list[[method]]$susie.pip[[j]], dscout.susieb.suc.list[[method]]$meta[[j]]$true_coef)
