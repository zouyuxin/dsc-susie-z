...
chunks = 0
smooth = FALSE
colors = c('lavenderblush', 'red', 'lightcyan', 'blue', 'darkseagreen1', 'green', 'plum1', 'purple')
...
for (method in names(roc.notest)) {
  ...
  if (i == 1) {
    plot(yy$x, yy$y, t="l", col=colors[i], ylab = "power", xlab ="FDR", main = 'Power vs False Discovery Rate', bty='l', lwd = 3, xlim = c(0,0.3), ylim = c(0,0.3))
  } else {
...
for (method in names(roc.est)) {
  yy = make_smooth(1 - roc.est[[method]]$rates$Precision, roc.est[[method]]$rates$Recall)
  if (i == 1) {
    plot(yy$x, yy$y, t="l", col=colors[i], ylab = "power", xlab ="FDR", main = 'Power vs False Discovery Rate', bty='l', lwd = 3, xlim = c(0,0.4), ylim = c(0,0.3))
  } else {
...
for (method in names(roc.est)) {
  yy = make_smooth(1 - roc.est[[method]]$rates$Precision, roc.est[[method]]$rates$Recall)
  if (i == 1) {
    plot(yy$x, yy$y, t="l", col=colors[i], ylab = "power", xlab ="FDR", main = 'Power vs False Discovery Rate', bty='l', lwd = 3, xlim = c(0,0.8), ylim = c(0,0.6))
  } else {
...
for (method in names(roc.est)) {
  yy = make_smooth(1 - roc.est[[method]]$rates$Precision, roc.est[[method]]$rates$Recall)
  if (i == 1) {
    plot(yy$x, yy$y, t="l", col=colors[i], ylab = "power", xlab ="FDR", main = 'Power vs False Discovery Rate', bty='l', lwd = 3, xlim = c(0,0.6), ylim = c(0,0.4))
  } else {
